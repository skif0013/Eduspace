...
namespace AuthService.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251105212326_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthService.Infrastructure.Identity.RoleIdentity", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<System.Guid>", b =>
                {
                    b.HasOne("AuthService.Infrastructure.Identity.RoleIdentity", null)
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
